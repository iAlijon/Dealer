                    ...
                    <form action="{{route('cars-list.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- text input -->
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4" {{$errors->has('category_id')?'is-invalid':''}} style="width: 100%;" name="category_id"
                                        id="category_id">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4" {{$errors->has('sub_category_id')?'is-invalid':''}} style="width: 100%;" name="sub_category_id"
                                        id="sub_category_id">
                                    <option selected="selected">---</option>
